...
<div class="row button-edit">
    <div class="col-md-6">
        <button class="btn btn-primary btn-block" type="button" id="edit_ava">Avatar </button>
    </div>
    <div class="col-md-6">
        <button class="btn btn-primary btn-block" type="button" id="edit_pass">Password </button>
    </div>
</div>
<hr>
...
<button class="btn btn-primary btn-block" id="save_edit_btn">Simpan </button>