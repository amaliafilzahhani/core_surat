            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row form">
                        ...
                        <div class="form-group">
                            <div class="col">
                                <button class="btn btn-primary" id="create_main_btn">Buat</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col">
                                    <select class="custom-select" id="folder_name2">
                            ...
                            <div class="form-group">
                                <div class="col">
                                    <button class="btn btn-primary" id="create_sub_btn">Buat</button>
                                </div>
                            </div>
                        </div>
